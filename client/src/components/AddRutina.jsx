    ...
    <div className="relative bg-gray-900 overflow-hidden min-h-screen">
      ...
      <div className="relative z-10 p-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold text-white">Añadir Rutina</h1>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-white mb-2">Añadir Ejercicio</label>            <div className="flex items-center space-x-4">
              <select
